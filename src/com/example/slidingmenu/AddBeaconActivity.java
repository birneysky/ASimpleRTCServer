...
import com.zijin.ibeacon.adapter.LeDeviceListAdapter;
...
//	private String ibeaconName="";//return ibeaconName
	...
	private PublicFind mPbulicFind;//需要帮助的众寻设备；如果是添加beacon，值为null
...
//		mHandler = new Handler();
		...
		checkBlueTooth();
		getCurrentLocation();
		Utils.isScanAddOrHelp=true;//暂定扫描场景为add help
	}
