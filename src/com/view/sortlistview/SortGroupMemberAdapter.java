...
public class SortGroupMemberAdapter extends BaseAdapter implements SectionIndexer {
	...
	private void setData(List<GroupMemberBean> list){
		if(list != null){
			this.list = list;
		} else {
			this.list = new ArrayList<GroupMemberBean>();
		}
	}
	...
	public View getView(final int position, View view, ViewGroup arg2) {
		...
		if (view == null) {
			...
			viewHolder.tvNumberCode = (TextView) view.findViewById(R.id.tv_number_code);
		...
		viewHolder.tvNumberCode.setText(this.list.get(position).getNumberCode());
