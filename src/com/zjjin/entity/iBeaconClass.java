...
public class iBeaconClass {
	...
	public static String iBeaconToString(iBeacon iBeacon) {
		return "iBeacon: name = " + iBeacon.name + ", major = " + iBeacon.major + ", minor = " + iBeacon.minor + ", Uuid = " + iBeacon.proximityUuid + ", Address = " + iBeacon.bluetoothAddress + ", txPower = " + iBeacon.txPower + ", rssi = " + iBeacon.rssi;
	}
